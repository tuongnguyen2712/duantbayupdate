...
<body>
  <section id="container">
    <header class="header black-bg">
      ...
      <!--logo start-->
      <a href="/quantri" class="logo"><b>DASH<span>IO</span></b></a>
      <!--logo end-->
      ...
      <div class="top-menu">
        <ul class="nav pull-right top-menu">
          <li><a class="logout" href="{{URL::to("quantri/logout")}}">Đăng Xuất</a></li>
        </ul>
      </div>
    </header>
    <!--header end-->
  ...
  {{-- <script type="text/javascript">
    $(document).ready(function() {
      var unique_id = $.gritter.add({
        ...
        // (string | optional) the image.store to display on the left
        image.store: '{{ asset('assets/Admin') }}/img/ui-sam.jpg',
